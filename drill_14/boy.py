...
class WalkingState:
    ...
    def draw(boy):
        ...
        boy.font.draw(sx - 80, sy + 60, 'picked_balls : %d' % boy.picked_ball_count, (255, 255, 0))
        boy.font.draw(sx - 80, sy + 120, 'picked_balls : %d %d' %(boy.x, boy.y), (255, 255, 0))
...
class Boy:
    ...
    def __init__(self):
        ...
        self.picked_ball_count = 0
        self.pre_x = self.x
        self.pre_y = self.y
        self.move_x = self.pre_x
        self.move_y = self.pre_y
    ...
    def update(self):
        ...
        self.move_x = self.x - self.pre_x
        self.move_y = self.y - self.pre_y
        self.pre_x = self.x
        self.pre_y = self.y
